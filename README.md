...
### Как оценивать
Все, кроме next, смотреть в ветке main, там все последние изменения
Next смотреть в PR. В ветке next'а не все последние изменения, поэтому по нему не стоит оценивать весь проект
